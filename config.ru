...
# Написать абстрактный класс User, с полями name, gender, age
...
# объекты класса создаются из строки, которая содержит JSON со всеми вышеуказанными полями
# User.new(some_json_in_string)
